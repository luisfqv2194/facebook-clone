...
export default function Friends() {
  ...
  const getData = async () => {
    ...
    if (data.status === 'ok') {
      dispatch({ type: 'friends/friends_success', payload: data.data })
    } else {
      dispatch({ type: 'friends/friends_error', payload: data.data })
    }
  }
  console.log(friends)
            ...
            <div className='friends_right_wrap'>
              ...
              <div className='flex_wrap'>
                {friends.friends.requests &&
                  friends.friends.requests.map((user) => (
                    <Card
                      userr={user}
                      key={user._id}
                      type='request'
            ...
            <div className='friends_right_wrap'>
              ...
              <div className='flex_wrap'>
                {friends.friends.sentRequests &&
                  friends.friends.sentRequests.map((user) => (
                    <Card
                      userr={user}
                      key={user._id}
                      type='sent'
            ...
            <div className='friends_right_wrap'>
              ...
              <div className='flex_wrap'>
                {friends.friends.friends &&
                  friends.friends.friends.map((user) => (
                    <Card
                      userr={user}
                      key={user._id}
                      type='friends'
